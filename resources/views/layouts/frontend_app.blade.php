...
<head>
    ...
    <title> @yield('title','Twincle | HOME')</title>
                    ...
                    <div class="col-lg-7 d-none d-lg-block">
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li><a href="{{url('shop/page')}}">Shop({{total_product_count()}})</a></li>
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        ...
                                        <div class="cart-content">
                                            <a href="cart.html">{{$cart_item->products->product_name}}</a>
                                            <span>QTY : {{$cart_item->product_quantity}}</span>
                                            <p>$70{{$cart_item->product_quantity * $cart_item->products->product_price}}</p>
                                            <p>$60</p>
                                            <i class="fa fa-times"></i>
                                        </div>
                                    </li>   
                                    ...
                                    <li>Subtotol: <span class="pull-right">$70.00</span></li>
                                    <li>
                                        <a class="btn btn-danger" href="{{route('cart.index')}}">GO to Cart</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                            ...
                            <ul class="metismenu">
                                ...
                                <li class="sidemenu-items">
                                    ...
                                    <ul aria-expanded="false">
                                        <li><a href="{{url('shop/page')}}">Shop Page</a></li>
...
<!-- end social-newsletter-section -->
  ...
  <!-- mouse_scroll.js -->
  <script src="{{asset('frontend_assets')}}/js/mouse_scroll.js"></script>
  <!-- scrollup.js -->
