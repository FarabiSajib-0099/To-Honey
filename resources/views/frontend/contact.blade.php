                    ...
                    <form action="{{url('contact/insert')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <input type="text" placeholder="Name" id="name" name="contact_name">
                            </div>
                            <div class="col-12  col-sm-6">
                            ...
                            <div class="col-12">
                                <textarea class="contact-textarea" placeholder="Message" id="Message" name="contact_message"></textarea>
                            </div>
                            <div class="col-12">
