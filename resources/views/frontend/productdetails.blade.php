           ...
           <div class="col-lg-6">
               <div class="product-single-img">
                   <div class="product-active owl-carousel">
                       <div class="item">
                           <img src="{{asset('uploads/productphotos')}}/{{$product_info->product_thumbnail_photo}}" alt="not found">
                       </div>
                    
                       @foreach ($product_images as $single_photo)
                         
                       <div class="item">
                        <img src="{{asset('uploads/product_multiple_photo')}}/{{$single_photo->product_multiple_image_name}}" alt="not found">
                       </div>  
                       @endforeach
           ...
           <div class="col-lg-6">
               <div class="product-single-content">
                   ...
                   <div class="rating-wrap fix">
                       <span class="pull-left">Tk{{$product_info->product_price}}</span>
                   ...
                   <ul class="cetagory">
                       <li>Category:</li>
                       <li><a href="#">{{$product_info->relationwithcattable->cat_name}}</a></li>
          ...
          @forelse ($related_products as $related_product)
               ...
               <div class="featured-product-wrap">
                   <div class="featured-product-img">
                       <img src="{{asset('uploads/productphotos')}}/{{$related_product->product_thumbnail_photo}}" alt="not found">
                   </div>
